...
export type Database = {
  public: {
    Tables: {
      ...
      tasks: {
        Row: { id: string; user_id: string; block_id: string | null; title: string; done: boolean | null; sort_order: number | null; reminder_at: string | null; created_at: string | null; updated_at: string | null };
        Insert: { id?: string; user_id: string; block_id?: string | null; title: string; done?: boolean | null; sort_order?: number | null; reminder_at?: string | null; created_at?: string | null; updated_at?: string | null };
        Update: { id?: string; user_id?: string; block_id?: string | null; title?: string; done?: boolean | null; sort_order?: number | null; reminder_at?: string | null; created_at?: string | null; updated_at?: string | null };
      };
      notes: {
      ...
      wallet_transactions: {
        Row: { id: string; user_id: string; type: "income" | "expense" | "saving"; title: string; amount: number; currency: "CRC" | "USD"; category: string; transaction_date: string; period: "weekly" | "biweekly" | "monthly"; created_at: string | null; updated_at: string | null };
        Insert: { id?: string; user_id: string; type: "income" | "expense" | "saving"; title: string; amount: number; currency?: "CRC" | "USD"; category: string; transaction_date: string; period: "weekly" | "biweekly" | "monthly"; created_at?: string | null; updated_at?: string | null };
        Update: { id?: string; user_id?: string; type?: "income" | "expense" | "saving"; title?: string; amount?: number; currency?: "CRC" | "USD"; category?: string; transaction_date?: string; period?: "weekly" | "biweekly" | "monthly"; created_at?: string | null; updated_at?: string | null };
      };
      wallet_budgets: {
