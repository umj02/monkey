...
export default function WalletPage() {
  ...
  return <AppShell><Toast toast={toast} onClose={() => setToast(null)} />
    <section className="page-pad pb-8 pt-8">
      ...
      <p className={cn("mt-1 text-center text-[11px] font-bold", lastError ? "text-monkey-pink" : syncStatus === "saving" || syncing ? "text-monkey-muted" : "text-monkey-greenDark")}>{lastError || (syncStatus === "saving" ? "Guardando cambios..." : syncing ? "Actualizando Wallet..." : syncStatus === "synced" ? "Wallet al día" : "")}</p>
