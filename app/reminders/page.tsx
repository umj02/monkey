...
export default function RemindersPage() {
  const { items, createReminder, updateReminder, toggleReminder, deleteReminder } = useReminders();
  ...
  return (
    <AppShell>
      ...
      <ConfirmSheet open={!!deleteId} title="¿Eliminar recordatorio?" body="Se quitará de tu lista local de recordatorios." onCancel={() => setDeleteId(null)} onConfirm={() => { if (deleteId) deleteReminder(deleteId); setDeleteId(null); notify("Recordatorio eliminado"); }} />
    </AppShell>
  );
}
