...
export function FormSheet({
  ...
  return (
    <div className="fixed inset-0 z-50 mx-auto flex w-full max-w-[430px] items-end overflow-hidden bg-black/50 px-4 pb-[calc(14px+var(--safe-bottom))] pt-[calc(44px+var(--safe-top))] sm:px-5">
      <form
        onSubmit={handleSubmit}
        className="flex max-h-[calc(100dvh-72px-var(--safe-top)-var(--safe-bottom))] w-full min-w-0 animate-slideUp flex-col overflow-hidden rounded-[28px] bg-white shadow-soft"
      >
        <div className="shrink-0 border-b border-gray-100/80 px-5 pb-4 pt-5">
        ...
        <div className="min-h-0 flex-1 overflow-y-auto overflow-x-hidden overscroll-contain px-5 py-5 [-webkit-overflow-scrolling:touch]">
          <div className="min-w-0 space-y-4">{children}</div>
        </div>

        <div className="shrink-0 border-t border-gray-100/80 bg-white px-5 pb-[calc(14px+var(--safe-bottom))] pt-3">
          {submitState === "error" ? (
