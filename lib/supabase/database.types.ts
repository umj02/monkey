...
export type Database = {
  public: {
    Tables: {
      ...
      calendar_events: {
        Row: { id: string; user_id: string; event_date: string; start_time: string | null; end_time: string | null; title: string; color: "yellow" | "blue" | "green" | "pink" | "purple" | "orange"; recurrence_type: "none" | "daily" | "custom_days" | null; recurrence_days: number[] | null; recurrence_until: string | null; recurrence_group_id: string | null; created_at: string | null; updated_at: string | null };
        Insert: { id?: string; user_id: string; event_date: string; start_time?: string | null; end_time?: string | null; title: string; color?: "yellow" | "blue" | "green" | "pink" | "purple" | "orange"; recurrence_type?: "none" | "daily" | "custom_days" | null; recurrence_days?: number[] | null; recurrence_until?: string | null; recurrence_group_id?: string | null; created_at?: string | null; updated_at?: string | null };
        Update: { id?: string; user_id?: string; event_date?: string; start_time?: string | null; end_time?: string | null; title?: string; color?: "yellow" | "blue" | "green" | "pink" | "purple" | "orange"; recurrence_type?: "none" | "daily" | "custom_days" | null; recurrence_days?: number[] | null; recurrence_until?: string | null; recurrence_group_id?: string | null; created_at?: string | null; updated_at?: string | null };
      };
      wallet_transactions: {
