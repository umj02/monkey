...
export default function RegisterPage() {
  return (
    <main className="safe-screen px-6 py-10">
      ...
      <p className="mt-1 text-gray-500">Organiza tu día de forma simple.</p>
      <form className="mt-8 space-y-4">
        <input className="h-14 w-full rounded-2xl border border-gray-200 px-4 outline-none focus:border-monkey-green" placeholder="Nombre" />
      ...
      <p className="mt-6 text-center text-sm text-gray-500">
        ¿Ya tienes cuenta? <Link href="/login" className="font-bold text-monkey-green">Ingresar</Link>
      </p>
    </main>
  );
}
