...
export type Database = {
  public: {
    Tables: {
      ...
      calendar_events: {
        Row: { id: string; user_id: string; event_date: string; start_time: string | null; end_time: string | null; title: string; icon_key: string | null; activity_type_key: string | null; color: "yellow" | "blue" | "green" | "pink" | "purple" | "orange"; recurrence_type: "none" | "daily" | "custom_days" | null; recurrence_days: number[] | null; recurrence_until: string | null; recurrence_group_id: string | null; done: boolean | null; source: string | null; challenge_id: string | null; challenge_task_id: string | null; is_locked: boolean | null; verification_status: string | null; reward_bananas: number | null; reactivation_count: number | null; reactivation_penalty: number | null; reactivation_penalty_date: string | null; expired_at: string | null; last_reactivated_at: string | null; created_at: string | null; updated_at: string | null };
      ...
      personal_challenges: {
        Row: { id: string; local_id: string | null; user_id: string; origin: string; title: string; description: string | null; icon_key: string | null; image_path: string | null; activity_type_key: string | null; frequency: string; status: string; start_date: string; end_date: string; reward_bananas: number; requires_guardian_verification: boolean; total_tasks: number; completed_tasks: number; claimed_at: string | null; metadata: Json; created_at: string | null; updated_at: string | null };
        Insert: { id?: string; local_id?: string | null; user_id: string; origin?: string; title: string; description?: string | null; icon_key?: string | null; image_path?: string | null; activity_type_key?: string | null; frequency?: string; status?: string; start_date: string; end_date: string; reward_bananas?: number; requires_guardian_verification?: boolean; total_tasks?: number; completed_tasks?: number; claimed_at?: string | null; metadata?: Json; created_at?: string | null; updated_at?: string | null };
        Update: { id?: string; local_id?: string | null; user_id?: string; origin?: string; title?: string; description?: string | null; icon_key?: string | null; image_path?: string | null; activity_type_key?: string | null; frequency?: string; status?: string; start_date?: string; end_date?: string; reward_bananas?: number; requires_guardian_verification?: boolean; total_tasks?: number; completed_tasks?: number; claimed_at?: string | null; metadata?: Json; created_at?: string | null; updated_at?: string | null };
      };
      challenge_tasks: {
        Row: { id: string; local_id: string | null; user_id: string; challenge_id: string; calendar_event_id: string | null; title: string; icon_key: string | null; activity_type_key: string | null; scheduled_date: string; scheduled_time: string | null; status: string; reward_bananas: number; checked_at: string | null; verified_at: string | null; metadata: Json; created_at: string | null; updated_at: string | null };
        Insert: { id?: string; local_id?: string | null; user_id: string; challenge_id: string; calendar_event_id?: string | null; title: string; icon_key?: string | null; activity_type_key?: string | null; scheduled_date: string; scheduled_time?: string | null; status?: string; reward_bananas?: number; checked_at?: string | null; verified_at?: string | null; metadata?: Json; created_at?: string | null; updated_at?: string | null };
        Update: { id?: string; local_id?: string | null; user_id?: string; challenge_id?: string; calendar_event_id?: string | null; title?: string; icon_key?: string | null; activity_type_key?: string | null; scheduled_date?: string; scheduled_time?: string | null; status?: string; reward_bananas?: number; checked_at?: string | null; verified_at?: string | null; metadata?: Json; created_at?: string | null; updated_at?: string | null };
      };
      banana_ledger: {
        Row: { id: string; local_id: string | null; user_id: string; source_type: string; source_id: string; amount: number; reason: string; metadata: Json; created_at: string | null };
        Insert: { id?: string; local_id?: string | null; user_id: string; source_type: string; source_id: string; amount: number; reason: string; metadata?: Json; created_at?: string | null };
        Update: { id?: string; local_id?: string | null; user_id?: string; source_type?: string; source_id?: string; amount?: number; reason?: string; metadata?: Json; created_at?: string | null };
      };
      wallet_categories: {
