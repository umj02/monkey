...
import { Bell, BellOff, CalendarDays, Check, HelpCircle, Plus, RefreshCw } from "lucide-react";
      ...
      <section className="page-pad pt-8">
        ...
        <div className="mt-5 flex min-h-11 items-center justify-between gap-3">
          ...
          <div className="flex shrink-0 items-center gap-2">
            <Link href="/welcome?review=1" className="grid h-11 w-11 place-items-center rounded-full bg-white shadow-card transition active:scale-95" aria-label="Aprender a usar Monkey Checks"><HelpCircle className="h-4 w-4 text-monkey-green" /></Link>
