...
export default function LoginPage() {
  ...
  async function submit() {
    ...
    if (!result.session) {
      setToast({ message: "No hay sesión activa. Confirmá tu correo o intentá de nuevo.", type: "error" });
      return;
    }
    router.push("/today");
  }
  ...
  return (
    <main className="app-screen px-6 py-10">
      ...
      <section className="mx-auto max-w-[360px] text-center">
        ...
        <h1 className="mt-5 text-2xl font-black tracking-tight">¡Hola de nuevo!</h1>
        <p className="mt-1 text-sm text-monkey-muted">Entrá con tu cuenta para guardar tus datos reales</p>
        ...
        <p className="mt-6 text-center text-sm text-gray-500">¿No tenés cuenta? <Link href="/register" className="font-bold text-monkey-green">Crear cuenta</Link></p>
      </section>
    </main>
  );
}
